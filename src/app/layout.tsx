...
export const metadata: Metadata = {
  title: "ToysHub - Premium Toys for All Ages",
  description: "Discover quality toys for children of all ages at ToysHub. Safe, fun, and educational toys with fast delivery and exceptional customer service.",
  keywords: "toys, children, educational toys, toy store, gifts, kids toys, safe toys",
  metadataBase: new URL("https://toyshub.example.com"),
  alternates: {
    canonical: "https://toyshub.example.com"
  },
  openGraph: {
    title: "ToysHub - Premium Toys for All Ages",
    description: "Shop quality toys for kids. Safe, fun, and educational. Free shipping on orders over $50.",
    url: "https://toyshub.example.com",
    siteName: "ToysHub",
    type: "website"
  },
  twitter: {
